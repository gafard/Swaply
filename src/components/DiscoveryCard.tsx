...
export default function DiscoveryCard({ item, onSwipeRight, onSwipeLeft, isFront }: Props) {
  ...
  if (!isFront) {
    return (
      <div className="absolute inset-0 translate-y-3 scale-[0.965] overflow-hidden rounded-[38px] border border-border bg-surface shadow-[0_18px_42px_rgba(16,32,58,0.08)]">
        {primaryImage ? (
        ...
        <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(255,255,255,0.45),rgba(255,255,255,0.12)_40%,rgba(16,32,58,0.45))]" />
      </div>
    );
  }
  ...
  return (
    <motion.div
      ...
      className="absolute inset-0 overflow-hidden rounded-[40px] border border-white/20 bg-surface shadow-[0_30px_80px_rgba(16,32,58,0.2)]"
    >
      <motion.div
        style={{ opacity: reserveOpacity }}
        className="absolute left-5 top-5 z-30 rounded-full border border-emerald-400/30 bg-emerald-500/14 px-4 py-2 text-[10px] font-black uppercase tracking-[0.16em] text-emerald-50 backdrop-blur-xl"
      >
        {t("reserve")}
      </motion.div>
      <motion.div
      ...
      <div className="relative h-full w-full bg-background">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(16,32,58,0.08)_0%,rgba(16,32,58,0.02)_25%,rgba(16,32,58,0.72)_100%)]" />

        <div className="absolute inset-x-5 top-5 z-20 flex items-start justify-between gap-3">
          <div className="rounded-full border border-white/14 bg-black/20 px-3 py-1.5 text-[10px] font-black uppercase tracking-[0.16em] text-white/72 backdrop-blur-md">
        ...
        <div className="absolute inset-x-5 bottom-5 z-20">
          <div className="rounded-[28px] border border-white/14 bg-black/35 px-4 py-4 backdrop-blur-xl shadow-[0_16px_40px_rgba(16,32,58,0.18)]">
            <div className="flex items-start justify-between gap-4">
              ...
              <div className="shrink-0 rounded-[20px] bg-white px-3.5 py-3 text-right shadow-[0_10px_30px_rgba(255,255,255,0.08)]">
